...
const en: Dict = {
  ...
  sec_activity: "Market activity (X Layer)",
  sec_backing: "Backing",
  sec_filings: "Underlying filings & dividends",
  sec_exit: "Exit & redemption",
...
const es: Dict = {
  ...
  sec_activity: "Actividad de mercado (X Layer)",
  sec_backing: "Respaldo",
  sec_filings: "Informes y dividendos del subyacente",
  sec_exit: "Salida y reembolso",
